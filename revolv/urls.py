...
urlpatterns = patterns(
    ...
    url(r'^get-involved/team', 'revolv.base.views.solar_ambassador_team', name='solar_ambassador_team'),
    url(r'^get-involved/apply', 'revolv.base.views.nonprofit_app', name='nonprofit_app'),
    url(r'^newsletter/subscribe', 'revolv.base.views.newsletter_subscription', name='newsletter_subscription'),
    ...
    url(r'^get-involved/education/solarfacts', 'revolv.base.views.solarfacts', name='solarfacts'),
    ...
    url(r'^blog-center/articles/free-rider-dilemma/', 'revolv.base.views.riderdilemma', name='riderdilemma'),
    url(r'^blog-center/articles/project-impact-areas/', 'revolv.base.views.impactareas', name='impactareas'),
    url(r'^blog-center/articles/partnership-with-dickinson/', 'revolv.base.views.partnershipdickinson', name='partnershipdickinson'),
    ...
    url(r'^blog-center/articles/ten-years-of-impact/', 'revolv.base.views.tenyearimpact', name='tenyearimpact'),
    url(r'^blog-center/articles/texting-for-change', 'revolv.base.views.textingforchange', name='textingforchange'),
    url(r'^blog-center/articles/coal-ash', 'revolv.base.views.coalash', name='coalash'),
    url(r'^blog-center/articles/evolving-energy/', 'revolv.base.views.evolvingenergy', name='evolvingenergy'),
    url(r'^blog-center/articles/plan-solar-and-benefits/', 'revolv.base.views.planforsolarbenefit', name='planforsolarbenefit'),
    url(r'^blog-center/articles/solar-ambassador-impact/', 'revolv.base.views.solarambassadorimpact', name='solarambassadorimpact'),
    ...
    url(r'^blog-center/articles/joining-solar-ambassador-team/', 'revolv.base.views.joiningsolarambassadorteam', name='joiningsolarambassadorteam'),
    url(r'^blog-center/articles/solar-education-online-campus/', 'revolv.base.views.solareducationonlinecampus', name='solareducationonlinecampus'),
